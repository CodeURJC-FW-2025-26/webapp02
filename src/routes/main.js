...
router.get('/receta/nueva', (req, res) => {
    // We pass an empty 'recipe' object so that the template doesn't fail
    // when trying to access properties like 'recipe.name'.
    // We also make sure that 'editing' is not passed or is 'false'.
